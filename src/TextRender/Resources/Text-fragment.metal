...
{}
float4 FS( TextRender_Resources_Text_FragmentInput input)
{
...
fragment float4 FS(TextRender_Resources_Text_FragmentInput input [[ stage_in ]], texture2d<float> SurfaceTexture [[ texture(0) ]], sampler SurfaceSampler [[ sampler(0) ]])
{
